    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header justify-content-between">
                ...
                @if($hakTambah > 0)
                <div>
                    <a class="modal-effect btn btn-primary-light" onclick="generateID()" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modaldemo8">Add Data <i class="fe fe-plus"></i></a>
                </div>
                @endif
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="table-1" class="table table-bordered text-nowrap border-bottom dataTable no-footer dtr-inline collapsed">
                        <thead>
                            ...
                            <th class="border-bottom-0">Illustrative image of the product</th>
                            <th class="border-bottom-0">Service code</th>
                            <th class="border-bottom-0">Service name</th>
                            <th class="border-bottom-0">Type</th>
                            <th class="border-bottom-0">Unit</th>
                            <th class="border-bottom-0">Type of service</th>
                            <th class="border-bottom-0">Active Services</th>
                            <th class="border-bottom-0">service value</th>
