    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Add Items</h6><button onclick="reset()" aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label for="kode" class="form-label">Product code <span class="text-danger">*</span></label>
                            <input type="text" name="kode" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="nama" class="form-label">Service name <span class="text-danger">*</span></label>
                            <input type="text" name="nama" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="jenisbarang" class="form-label">Type of service</label>
                        ...
                        <div class="form-group">
                            <label for="satuan" class="form-label">How you received the service</label>
                        ...
                        <div class="form-group">
                            <label for="merk" class="form-label">Service taken by:</label>
                        ...
                        <div class="form-group">
                            <label for="harga" class="form-label">Service value <span class="text-danger">*</span></label>
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0)" onclick="checkForm()" id="btnSimpan" class="btn btn-primary">Update Sale <i class="fe fe-check"></i></a>
                <a href="javascript:void(0)" class="btn btn-light" onclick="reset()" data-bs-dismiss="modal">Sale is not updated <i class="fe fe-x"></i></a>
            </div>
        </div>
    </div>
</div>
