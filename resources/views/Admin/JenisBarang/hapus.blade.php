    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-body text-center p-4 pb-5">
                ...
                <h3 class="mb-5">Sure delete it <span id="vjenisbarang"></span> ?</h3>
                ...
                <button onclick="submitFormH()" class="btn btn-danger-light pd-x-25" id="btnSubmit">Yes...Go</button>
                <button type="reset" data-bs-dismiss="modal" class="btn btn-default pd-x-25">No Cancel</button>
            </div>
        </div>
    </div>
</div>
