...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">CSLB POTENTIAL</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-gray">Master Sale</li>
                <li class="breadcrumb-item active" aria-current="page">cslb potential</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
                    ...
                    @if ($hakTambah > 0)
                        <div>
                            <a class="modal-effect btn btn-primary-light" data-bs-effect="effect-super-scaled"
                                data-bs-toggle="modal" href="#modaldemo8">Add Data
