        ...
        <div class="modal-content modal-content-demo">
            <form method="GET" action="{{ url('admin/logout') }}" name="myFormH" enctype="multipart/form-data">
                ...
                <div class="modal-body text-center p-4 pb-5">
                    ...
                    <h3 class="mb-5">are you about to go out?</h3>
                    <button type="submit" class="btn btn-danger-light pd-x-25">yes end</button>
                    <button type="reset" data-bs-dismiss="modal" class="btn btn-default pd-x-25">no, sorry</button>
                </div>
            </form>
        </div>
    </div>
