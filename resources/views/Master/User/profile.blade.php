                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                            ...
                            <input class="input100 form-control" value="{{Session::get('currentpassword')}}" name="currentpassword" type="password" placeholder="Current Password">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="wrap-input100 validate-input input-group" id="Password-toggle1">
                            ...
                            <input class="input100 form-control" value="{{Session::get('newpassword')}}" name="newpassword" type="password" placeholder="New Password">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="wrap-input100 validate-input input-group" id="Password-toggle2">
                            ...
                            <input class="input100 form-control" value="{{Session::get('confirmpassword')}}" type="password" name="confirmpassword" placeholder="Confirm Password">
                        </div>
                    </div>
                </div>
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-success">Update</button>
                    <a href="javascript:void(0)" onclick="resetP()" class="btn btn-danger my-1">Cancelled</a>
                </div>
            </form>
        </div>
    </div>
    <div class="col-xl-8">
        <div class="card">
            ...
            <form action="{{url('/admin/updateProfile').'/'.$data->user_id}}" method="POST" name="myFormUpdate" enctype="multipart/form-data" onsubmit="return validateUpdate()">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="nmlengkap">Full name</label>
                        <input type="text" name="nmlengkap" value="{{$data->user_nmlengkap}}" class="form-control" id="nmlengkap" placeholder="Enter You Name">
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer text-end">
                    ...
                    <a href="{{url('/admin/profile')}}/{{Session::get('user')->user_id}}" class="btn btn-danger my-1">Cancelled</a>
                </div>
            </form>
        </div>
