    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Add User</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <form method="POST" action="{{ route('user.store') }}" name="myForm" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                <label for="nmlengkap" class="form-label">Full name</label>
                                <input type="text" name="nmlengkap" class="form-control" placeholder="Enter You Nmae..">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="you.email@nevtis.com">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="pwdU" class="form-label">Repeat Password</label>
                                <input type="password" name="pwdU" class="form-control" placeholder="Repeat Password">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">Yes Save Date<i class="fe fe-check"></i></button>
                    <a href="javascript:void(0)" class="btn btn-light" onclick="reset()" data-bs-dismiss="modal">Oh No Cancel <i class="fe fe-x"></i></a>
                </div>
            </form>
        </div>
    </div>
