    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Change User</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <form method="POST" name="myFormU" id="myFormU" enctype="multipart/form-data" onsubmit="return validateFormUpdate()">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                <label for="nmlengkapU" class="form-label">Full name</label>
                                <input type="text" name="nmlengkapU" class="form-control" placeholder="Enter You Name..">
                            </div>
                            <div class="form-group">
                                <label for="usernameU" class="form-label">Username</label>
                                <input type="text" name="usernameU" class="form-control" placeholder="Enter You Username..">
                            </div>
                            <div class="form-group">
                                <label for="emailU" class="form-label">Email</label>
                                <input type="email" name="emailU" class="form-control" placeholder="you.email@nevtis.com">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="alert alert-info" role="alert">
                                ...
                                <span class="alert-inner--text">Skip if you don't want to change the password.</span>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="pwdUU" class="form-label">Repeat Password</label>
                        ...
                        <div class="col-md-5">
                            <div class="alert alert-info" role="alert">
                                <span class="alert-inner--icon"><i class="fe fe-info"></i></span>
                                <span class="alert-inner--text">Skip if you don't want to change the photo.</span>
                            </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success">Save Changes <i class="fe fe-check"></i></button>
                    <a href="javascript:void(0)" class="btn btn-light" onclick="resetU()" data-bs-dismiss="modal">oh No Cancell <i class="fe fe-x"></i></a>
                </div>
            </form>
        </div>
    </div>
