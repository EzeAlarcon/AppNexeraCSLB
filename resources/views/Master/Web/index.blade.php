        ...
        <div class="card border-0 shadow">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mx-4">
                    <h6 class="mr-4">cslb-nexera Website</h6>
    ...
    <div class="col-12 col-md-12 col-lg-6 mb-4">
        <form action="{{ route('web.update', $d->web_id) }}" method="POST" name="myForm" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div class="card shadow border-0">
                <div class="card-header">
                    <h6 class="mt-2 fw-bold">Change Settings</h6>
                </div>
                <div class="card-body">
                    @csrf
                    @method('PUT')
                    <div class="alert alert-info alert-icon d-flex shadow" role="alert">
                        ...
                        <div class="alert-icon-content ms-1 mt-1">
                            <h6 class="alert-heading">Image Extensions</h6>
                            .jpg .jpeg .png
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Nexera-CSLB Website</label>
                ...
                <div class="card-footer">
                    <div class="mb-2">
                        <button type="submit" class="btn btn-success btn-md shadow">Save Changes
