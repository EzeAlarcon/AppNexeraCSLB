                ...
                <div class="container text-center">
                    <div class="error-template">
                        ...
                        <h3 class="error-details">
                            Oops, the page you want to see is not available for you at the moment. If you have questions about why, contact ezequiel.a@nevtis.com with the subject, I do not have access, error 404. We appreciate your understanding.!
                        </h3>
                        <div class="text-center">
                            <a class="btn btn-warning mt-5 mb-5" href="{{url('/admin')}}"> <i class="fa fa-long-arrow-left"></i> Return to work area </a>
                        </div>
                    </div>
                </div>
            </div>
